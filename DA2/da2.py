...
print(f)
@st.cache(persist=True)# for fast update and store data in harddisk
def load_data():
...
select = st.sidebar.selectbox('Visualization type',['Bar plot','SunburstPlot'],key='3')
...
select = st.sidebar.selectbox('Visualization type',['Histogram','Funnel Plot'],key='5')
...
select = st.sidebar.selectbox('Visualization type',['Heat Map-2D','Scatter Plot'],key='6')
...
select = st.sidebar.selectbox('Visualization type',['Histogram','Heat Map-2D'],key='7')
Product_status = data['Product_line']
...
select = st.sidebar.selectbox('Visualization type',['Histogram','Sunburst Plot'],key='8')
